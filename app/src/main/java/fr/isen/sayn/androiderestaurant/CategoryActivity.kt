...
import fr.isen.sayn.androiderestaurant.model.DataResult
import fr.isen.sayn.androiderestaurant.model.Items
            ...
            items(dishes) { menuItem ->
                Row(
                    ...
                    modifier = Modifier
                        .padding(16.dp)
                        .fillMaxWidth()
                        .clickable { onDishClicked(menuItem) }
                ) {
                    AsyncImage(
                        model = menuItem.images.last(),
                        contentDescription = null,
                        modifier = Modifier
                            .size(100.dp) // Taille fixe pour toutes les images
                    )
